...
const BrandingUpload = (props) => {
  // const { updateBranding } = useProjectByUserId();

  //   To check if the signed contract is uploaded
  const { signedContractUploaded } = props;
  ...
  useEffect(() => {
    const uploadFile = () => {
      const storageRef = ref(
        storage,
        `${appName}_${company}_${firstName}_userId:${userId}/branding/brand_files_${currentDate}_${file.name}`
      );
  ...
  // Upload function
  const uploadFile = (e) => {
    document.getElementById("select-brand").click();
                  ...
                  {signedContractUploaded === true ? (
                    ...
                    <>
                      <TooltipComponent
                        ...
                        content="Your contract is not signed yet."
                        target="#tooltip"
                      >
                        <div id="tooltip">
                          <DisabledButton
