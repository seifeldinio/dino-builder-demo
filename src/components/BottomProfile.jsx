      ...
      <Link to="/profile">
        ...
        <div className="flex flex-row  space-x-3 items-center m-3 pt-0.5 pb-0.5 ">
          {pathname === "/profile" ? (
            <>
              <LazyLoadImage
                className="rounded-full object-cover outline outline-4 outline-lemon w-[40px] h-[40px] "
                src={profilePicture}
                effect="blur"
          ...
          <Link to="/settings">
            {pathname === "/settings" ? (
              <div className=" bg-lemon p-2 rounded-full transition-color duration-200">
                <BsGearFill className="h-[19px] w-[19px] " />
              </div>
            ) : (
              <Tooltip title="Settings">
                <div
                  data-tour="29"
                  className="bg-[#EEEEEE] p-2 hover:bg-gray-100 rounded-full transition-color duration-200 dark:bg-button-dark dark:hover:bg-hover-dark "
                >
